...
export const personalDescriptions=[
  ...
  'As a front-end developer, React has been my go-to framework for building interactive and dynamic user interfaces. My proficiency in React allows me to create responsive and visually appealing web applications that deliver exceptional user experiences.'
]
